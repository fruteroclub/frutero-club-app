...
const MENU_ITEMS: MenuItemType[] = [
  { displayText: 'frutas', href: '/frutas', isMobileOnly: false },
  { displayText: 'proyectos', href: '/proyectos', isMobileOnly: false },
        ...
        <div className="">
          <Link className="flex items-center" href="/">
            <Image
              ...
              width={128}
              height={128}
              className="w-14 transition duration-500 ease-in-out hover:rotate-[-25deg] lg:w-12"
              priority
            />
