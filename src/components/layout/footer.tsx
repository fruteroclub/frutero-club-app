...
export default function Footer({
  ...
  return (
    <footer className="w-full bg-background">
      <div className="mx-auto flex max-w-7xl flex-col gap-y-4 px-4 pb-4 pt-2 md:flex-row md:items-center md:justify-between md:px-6 md:pb-6 lg:px-8">
          ...
          {navigation.map((item) => (
            <div key={item.name}>
              <a
                ...
                className="text-secondary hover:text-primary lg:text-lg"
              >
        ...
        {!isHomePage && (
          <div className="md:min-w-1/3 flex flex-col items-center justify-center gap-x-3 gap-y-0 md:order-1 md:flex-row">
            <div className="order-2 flex items-center gap-x-1 md:order-1">
              <Image
                src="/images/logos/kukulcan-logo-color.png"
                alt="kiwik logo: kukulcán, co-founder of Frutero Club and kiwik Agent"
                width={128}
                height={128}
                className="w-14 transition duration-300 ease-in-out hover:rotate-[-25deg] md:w-12"
              />
            </div>
